...
<link rel="stylesheet" href="horoscope-meteo.css">
...
$nomsign[1]= $_SESSION["belier"]; 
$nomsign[2] = $_SESSION["taureau"];
$nomsign[3] = $_SESSION["gemeaux"]; 
$nomsign[4] = $_SESSION["cancer"]; 
$nomsign[5] = $_SESSION["lion"];
$nomsign[6] = $_SESSION["vierge"];
$nomsign[7] = $_SESSION["balance"];
$nomsign[8] = $_SESSION["scorpion"];
$nomsign[9] = $_SESSION["sagittaire"]; 
$nomsign[10] = $_SESSION["capricorne"];
$nomsign[11] = $_SESSION["verseau"];
$nomsign[12] = $_SESSION["poissons"]; 




$affsign1 = rand(1,$nbsign); 
$affsign2 = rand(1,$nbsign); 
$affsign3 = rand(1,$nbsign); 
$affsign4 = rand(1,$nbsign); 
$affsign5 = rand(1,$nbsign); 
$affsign6 = rand(1,$nbsign); 
$affsign7 = rand(1,$nbsign); 
$affsign8 = rand(1,$nbsign); 
$affsign9 = rand(1,$nbsign); 
$affsign10 = rand(1,$nbsign); 
$affsign11 = rand(1,$nbsign); 
$affsign12 = rand(1,$nbsign); 
?>        
...
<div id="weather">
    ...
    <br>
		<br>
		<span>Horoscope : asiaflash.com</span>
</div>
...
if (img == "o") {
	$("#met").css('background', 'url(image/ville/'+weather.city.toLowerCase()+'.jpg) center center no-repeat fixed rgb(17, 146, 211)');
	 ...
	 /* html += '<h5 class=humid><i class="icon-humidite"></i> '+Math.round(weather.humidity)+' <span class=petit>%</span></h5>';  */
	  ...
	  // Jour + 1
	  html2 = '<ul><li id=j1><div class="picto'+weather.tomorrow.code+'  imgpetite" ><h4>Demain</h4>' ;
	   html2 += '<h4 class=temp><span class="temp_min">'+weather.tomorrow.low+'&deg;</span><br>' ;
	  html2 += '<span class="temp_max">'+weather.tomorrow.high+'&deg;</span></h4>' ;
	  html2 += '<h5 class=descr>'+FR[weather.tomorrow.code]+'</h5>' ;
	 /* html += '<h5>Fete : '+fete1+'</h5></div></li>' ;*/
	  
	   // Jour + 2
	  html2 += '<li  id=j2><div class="picto'+weather.forecasts.two.code+'  imgpetite" ><h4>'+date_fr_2+'</h4>' ;
	   html2 += '<h4 class=temp><span class="temp_min">'+weather.forecasts.two.low+'&deg;</span><br>' ;
	  html2 += '<span class="temp_max">'+weather.forecasts.two.high+'&deg;</span></h4>' ;
	  html2 += '<h5 class=descr>'+FR[weather.forecasts.two.code]+'</h5>';
	  	  
	   // Jour + 3
	   html2 += '<li  id=j3><div class="picto'+weather.forecasts.three.code+'  imgpetite" ><h4>'+date_fr_3+'</h4>' ;
	   html2 += '<h4 class=temp><span class="temp_min">'+weather.forecasts.three.low+'&deg;</span><br>' ;
	  html2 += '<span class="temp_max">'+weather.forecasts.three.high+'&deg;</span></h4>' ;
	  html2 += '<h5 class=descr>'+FR[weather.forecasts.three.code]+'</h5>';
	 
	    // Jour + 4
	  html2 += '<li  id=j4><div class="picto'+weather.forecasts.four.code+'  imgpetite" ><h4>'+date_fr_4+'</h4>' ;
	  html2 += '<h4 class=temp><span class="temp_min">'+weather.forecasts.four.low+'&deg;</span><br>' ;
	  html2 += '<span class="temp_max">'+weather.forecasts.four.high+'&deg;</span></h4>' ;
	  html2 += '<h5 class=descr>'+FR[weather.forecasts.four.code]+'</h5></div></li></ul>';
